...
//   private _filter(contacts:any, term:any) {
//     term = term.toLocaleLowerCase();
//     return contacts.filter((contact: { name: string; phone: string; email: string; }) => {
//       return (
...
//   public queryForBitcoin(){
//     return axios.get(BITCOIN_URL)
//      .then(res =>res.data)
...
export class ContactService {
  ...
  public getEmptyContact() {
    return { name: '', email: '', phone:'999 999 999' }
  }
  ...
  public getById(contactId: string) {
    ...
    // Just added a delay so it feels async
